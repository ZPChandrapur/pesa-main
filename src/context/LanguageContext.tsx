...
const translations: Record<Language, Record<string, string>> = {
  mr: {
    ...
    gskStPopulation: 'ग्रामपंचायत अनु.जाती लोकसंख्या',
    villagePopulation: 'गावाची लोकसंख्या',
    villageSTPopulation: 'गावाची अनु.जाती लोकसंख्या',
    amountPerHeadSTPopulation: 'प्रति व्यक्ती अनु.जाती लोकसंख्या रक्कम',
