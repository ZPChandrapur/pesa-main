...
const translations: Record<Language, Record<string, string>> = {
  mr: {
    ...
    annualReceivedFund: 'वार्षिक प्रस्तावित निधी (रु.)',
    receivedInterest: 'प्राप्त व्याजाची रक्कम',
    totalReceivedFund: 'एकूण प्रस्तावित निधी (रु.),',
    ...
    releasedAmount: 'प्रस्तावित निधी (रु.)',
   ...
   // tech_approval_no: 'तांत्रिक मंजुरी क्रमांक',
    ...
    agreement_approval_amount: 'प्रस्तावित निधी',
    ...
    releaseAmountTitle: 'प्रस्तावित निधी नाही, तुम्ही काम जोडू शकत नाही',
