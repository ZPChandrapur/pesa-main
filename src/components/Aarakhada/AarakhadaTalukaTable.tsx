...
console.log('Received works prop in table:', works);
  ...
  // Default: Show all rows (no front-end filtering applied here)
  // Table columns displayed for both financial and physical as required.
  ...
  <tbody>
    {works.length === 0 ? (
      <tr>
        <td colSpan={workType === 'financial' ? 12 : 9} className="px-4 py-8 text-center text-gray-500">
